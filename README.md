...
Examples:
```powershell
npm run cli -- sync channel --channelId UCDppX9rguA9xrz3-ovMqLDQ --days 14 --maxVideos 50 --maxCommentsPerVideo 2000
npm run cli -- sync video --videoId VIDEO_ID
npm run cli -- sync videos --videoIds id1,id2,id3
npm run cli -- sync range --channelId UCDppX9rguA9xrz3-ovMqLDQ --from 2024-01-01 --to 2026-01-01 --maxVideos 500
npm run cli -- classify channel --channelId UCDppX9rguA9xrz3-ovMqLDQ
npm run cli -- query --channelId UCDppX9rguA9xrz3-ovMqLDQ --category bug --since 2026-01-01 --minLikes 2 --contains website
npm run cli -- report --channelId UCDppX9rguA9xrz3-ovMqLDQ --since 2026-01-01 --until 2026-02-01 --format md
